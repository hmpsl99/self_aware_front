...
const routes = [
  ...
  {
    path: "/initialtestexp",
    name: "initial test explananation",
    component: InitialTestExpView,
    meta: { auth: true, test: false },
  },
  {
    path: "/initialtest",
    name: "initial test",
    component: InitialTestQView,
    meta: { auth: true, test: false },
  },
  {
    path: "/initialtestresult",
    name: "initial test result",
    component: InitialTestResult,
    meta: { auth: true, test: true },
  },
  {
    path: "/home",
    name: "home page",
